...
const TYPING_SPEED = 105;
const DELETING_SPEED = 60;
const PAUSE_AFTER_TYPING = 2600;
const PAUSE_AFTER_DELETING = 650;
...
function Spotlight({
  ...
  return (
    <div onMouseMove={move} className={`premium-spotlight ${className}`}>
      {children}
    </div>
  );
}
...
export default function Home() {
  ...
  useEffect(() => {
    ...
    if (isDeleting && typedTitle === "") {
      timeout = setTimeout(() => {
        setTitleIndex(
          (current) => (current + 1) % rotatingTitles.length,
        );
    ...
    timeout = setTimeout(() => {
      if (isDeleting) {
        setTypedTitle((value) => value.slice(0, -1));
      } else {
        setTypedTitle(
    ...
    return () => clearTimeout(timeout);
  }, [typedTitle, currentTitle, isDeleting]);

  useEffect(() => {
    const timer = setInterval(() => {
      setImageIndex(
        (current) => (current + 1) % cyberImages.length,
      );
    }, 7000);
  ...
  return (
    <main className="sicsi-home">
      ...
      <header className="fixed inset-x-0 top-0 z-50 px-4 pt-4 sm:px-6 lg:px-8">
        <nav className="mx-auto flex h-[70px] max-w-[1420px] items-center justify-between rounded-[20px] border border-white/[.08] bg-[#06090d]/70 px-4 shadow-2xl backdrop-blur-2xl sm:px-6">
          ...
          <div className="hidden items-center gap-8 lg:flex">
            ...
            <a href="#metodo" className="nav-item">
              Método
            </a>
            <a href="#cursos" className="nav-item">
              Cursos
            </a>
            <a href="#simulacoes" className="nav-item">
              Simulações
            </a>
          </div>
          ...
          <div className="hidden items-center gap-2 sm:flex">
            ...
            <Link href="/registo" className="premium-button">
              Começar
              <IconArrow />
            </Link>
          </div>
        ...
        <div className="mx-auto grid w-full max-w-[1420px] items-center gap-16 lg:grid-cols-[1fr_.95fr]">
          <div className="relative z-10">
            <div className="hero-status">
              ...
              PLATAFORMA DE CONSCIENCIALIZAÇÃO
            </div>
            ...
            <div className="mt-9 flex flex-col gap-3 sm:flex-row">
              <Link href="/registo" className="hero-primary-button">
              ...
              <a href="#metodo" className="hero-secondary-button">
            ...
            <div className="hero-visual">
              {cyberImages.map((image, index) => (
                <img
                  key={image}
                  src={image}
                  alt="Ambiente tecnológico de cibersegurança"
      ...
      <section
        id="sobre"
        className="relative px-5 py-28 sm:px-8 lg:px-10 lg:py-36"
      >
      ...
      <section
        id="metodo"
        className="border-y border-white/[.06] bg-[#07090c] px-5 py-28 sm:px-8 lg:px-10 lg:py-36"
      >
        <div className="mx-auto max-w-[1420px]">
          ...
          <div className="relative min-h-[600px] overflow-hidden rounded-[32px] border border-white/[.08]">
            ...
            <div className="relative flex min-h-[600px] items-center p-8 sm:p-12 lg:p-20">
              <div className="max-w-2xl">
                ...
                <Link href="/registo" className="premium-button mt-9">
                  Explorar plataforma
                  <IconArrow />
                </Link>
              </div>
        ...
        <div className="mx-auto max-w-[1420px]">
          <div className="cta-panel">
            ...
            <div className="relative z-10 mx-auto max-w-4xl text-center">
              ...
              <div className="section-label mt-7 justify-center">
                <span />
                SICSI
                <span />
              </div>
        ...
        <div className="mx-auto flex max-w-[1420px] flex-col gap-8">
          ...
          <div className="footer-credit-wrap">
            <p className="footer-credit">
              ...
              <span
                className="footer-fingerprint"
                role="img"
                aria-label="impressão digital"
              >
                🫆
              </span>
            </p>
