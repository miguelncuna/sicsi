...
export default function DefinicoesAdminPage() {
  ...
  const [perfil, setPerfil] =
    useState<PerfilAdministrador | null>(
      null
    );
  ...
  const [aGuardarNome, setAGuardarNome] =
    useState(false);

  const [aGuardarEmail, setAGuardarEmail] =
    useState(false);

  const [
    aAlterarPalavraPasse,
    setAAlterarPalavraPasse,
  ] = useState(false);
  ...
  async function carregarPerfil() {
    ...
    try {
      ...
      if (
        ...
        console.error(
          "Erro ao carregar perfil administrativo:",
          error
        );
      ...
      const perfilCarregado: PerfilAdministrador =
        {
          id: data.id,
          nome_completo:
            data.nome_completo ||
      ...
      console.error(
        "Erro ao carregar definições administrativas:",
        erro
      );
  ...
  async function atualizarNome() {
    ...
    if (
      ...
      mostrarMensagem(
        "erro",
        "Introduza o nome completo com pelo menos 3 caracteres."
      );
    ...
    try {
      ...
      if (!data) {
        mostrarMensagem(
          "erro",
          "O sistema não conseguiu confirmar a alteração."
        );

        return;
      }

      const perfilAtualizado: PerfilAdministrador =
        {
          id: data.id,
          nome_completo:
            data.nome_completo ||
      ...
      mostrarMensagem(
        "sucesso",
        "Nome do administrador actualizado com sucesso."
      );
    } catch (erro) {
      console.error(
        "Erro ao actualizar nome:",
   ...
   * ==========================================================
   *
   * Agora a alteração passa pela API administrativa.
   *
   * Não usamos:
   *
   * supabase.auth.updateUser()
   *
   * porque esse método segue o fluxo normal de confirmação
    ...
    try {
      ...
      if (
        ...
        mostrarMensagem(
          "erro",
          resultado.erro ||
            "Não foi possível actualizar o e-mail."
        );
       ...
       * os dados visíveis na interface.
       */
      ...
      mostrarMensagem(
        "sucesso",
        "E-mail actualizado com sucesso. Não é necessária confirmação por e-mail."
      );
    } catch (erro) {
      console.error(
      ...
      mostrarMensagem(
        "erro",
        "Ocorreu um erro ao actualizar o e-mail."
      );
    } finally {
      setAGuardarEmail(
        false
    ...
    <main className="min-h-full bg-slate-50">
      ...
      <div className="mx-auto w-full max-w-6xl px-4 py-5 sm:px-6 lg:px-8">
          ...
          <div className="mt-3 flex items-start gap-3">
            ...
            <div>
              ...
              <p className="mt-1 max-w-2xl text-sm leading-6 text-slate-500">
                Gerencie a sua conta administrativa e as principais informações do SICSI.
              </p>
        ...
        <section className="mb-5 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
          ...
          <div className="h-1 bg-gradient-to-r from-blue-800 via-blue-600 to-emerald-500" />
          ...
          <div className="flex flex-col gap-5 p-5 sm:flex-row sm:items-center sm:p-6">
            ...
            {perfil?.foto_url ? (
              <img
                ...
                alt="Fotografia do administrador"
                className="h-20 w-20 shrink-0 rounded-2xl object-cover ring-1 ring-slate-200"
              />
            ) : (
              <div className="flex h-20 w-20 shrink-0 items-center justify-center rounded-2xl bg-blue-800 text-2xl font-bold text-white shadow-sm">
                {iniciais}
              </div>
            )}
            ...
            <div className="shrink-0 rounded-xl border border-blue-100 bg-blue-50 px-4 py-3 sm:min-w-[150px]">

              <FaShieldAlt className="text-lg text-blue-700" />

              <p className="mt-2 text-[10px] font-bold uppercase tracking-wider text-blue-500">
                Nível de acesso
              </p>

              <p className="mt-0.5 text-sm font-bold uppercase text-blue-900">
                Administrador
              </p>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500">
                      Nome utilizado na conta administrativa.
                    </p>
              ...
              <div className="border-b border-slate-100 px-5 py-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500">
                      Endereço associado à conta administrativa.
                    </p>
              ...
              <div className="p-5">
                ...
                <div className="flex flex-col gap-3 sm:flex-row">
                  ...
                  <input
                    ...
                    placeholder="administrador@sicsi.com"
                  />
              ...
              <div className="border-b border-slate-100 px-5 py-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500">
                      Mantenha protegida a conta administrativa.
                    </p>
            ...
            <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500">
                    Estado da conta administrativa
                  </p>
