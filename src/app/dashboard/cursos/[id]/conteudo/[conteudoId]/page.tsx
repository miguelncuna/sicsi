...
import FormularioFeedback from "@/components/feedback/FormularioFeedback";
...
export default async function ConteudoPage({
  ...
  /*
   * O Supabase pode devolver a relação
   * como objecto ou array.
   */
  ...
  /*
   * ==========================================================
   * 8. PROGRESSO DO CONTEÚDO ACTUAL
   * ==========================================================
   */
  ...
  /*
   * ==========================================================
   * 9. PROGRESSO REAL DO CURSO
   *
   * Aqui deixamos de confundir "posição de navegação"
   * com "progresso real".
   * ==========================================================
   */

  const {
    data: progressosCurso,
  } =
    await supabase
      .from(
        "progresso_utilizador"
          ...
          ">
            ...
            <div>
              ...
              <p className="mt-1 text-sm font-semibold text-slate-800">
                ...
                {totalConteudos} conteúdos concluídos
              </p>
        ...
        ">
          ...
          ">
            ...
            <FormularioFeedback
              ...
              titulo="Como foi este conteúdo?"
              descricao="A sua opinião ajuda-nos a melhorar a experiência de aprendizagem no SICSI."
            />
